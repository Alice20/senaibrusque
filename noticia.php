<section id="noticias" class="container-fluid">
    ...
    <div class="row"><!-- Linha 1-->
        ...
        <div class="panel panel-success col-lg-3 col-md-3 col-sm-3">
            <div class="panel-heading">Título da Notícia 1</div>
            <div class="panel-body">Resumo da notícia 1...</div>

            <!-- botão que dispara a modal -->
            <button id="1" type="button" class="btn btn-success center" data-toggle="modal" data-target="#noticia1">leia mais...</button>
        ...
        <!-- Painel de Notícia 2-->
        <div class="panel panel-success col-lg-3 col-md-3 col-sm-3">
            <div class="panel-heading">Título da Notícia 2</div>
            <div class="panel-body">Resumo da notícia 2...</div>

            <!-- botão que dispara a modal -->
            <button id="2" type="button" class="btn btn-success center" data-toggle="modal" data-target="#noticia2">leia mais...</button>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Título da Notícia 2</h4>
                        </div>
                        <div class="modal-body">
                            <time class="h4">30/11/2015 19:30:45</time>
                            <p>Autor: Sicrano Mingal</p>

                            <p>Parágrafo 1 da notícia 2</p>
        ...
        <!-- Painel de Notícia 3-->
        <div class="panel panel-success col-lg-3 col-md-3 col-sm-3">
            <div class="panel-heading">Título da Notícia 3</div>
            <div class="panel-body">Resumo da notícia 3...</div>

            <!-- botão que dispara a modal -->
            <button id="3" type="button" class="btn btn-success center" data-toggle="modal" data-target="#noticia3">leia mais...</button>
            ...
            <div id="noticia3" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">Título da Notícia 3</h4>
                        </div>
                        <div class="modal-body">
                            <time class="h4">25/10/2015 10:20:05</time>
                            <p>Autor: Teobaldo Mingal</p>

                            <p>Parágrafo 1 da notícia 3</p>
