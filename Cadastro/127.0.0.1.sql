...
--
-- Estrutura da tabela `notica`
--

CREATE TABLE IF NOT EXISTS `notica` (
...
--
-- Restrições para a tabela `notica`
--
ALTER TABLE `notica`
  ADD CONSTRAINT `notica_ibfk_1` FOREIGN KEY (`idautor`) REFERENCES `autor` (`idautor`);
